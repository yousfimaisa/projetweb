<?php
require_once 'C:/xampp/htdocs/dele3a/CRUD/config.php';  // Chemin absolu vers config.php
require_once 'C:/xampp/htdocs/dele3a/CRUD/controller/repondaviscontroller.php';  // Chemin relatif basé sur l'emplacement du fichier courant
...
<body>
    ...
    <nav>
        <ul>
            <li><a href="deashboardFront.php">Accueil</a></li>
